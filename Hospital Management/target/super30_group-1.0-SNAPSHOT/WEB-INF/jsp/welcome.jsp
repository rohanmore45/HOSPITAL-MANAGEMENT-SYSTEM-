...
<body>
    ...
    <main class="container-fluid" align="center" >
        ...
        <div class="inside">
            ...
            <h3>HMS will help you to manage all the Tasks related to Hospital Works.</h3>
            <h4>Please login to use HMS.
                If not registered till now, <br> Please Register now ! </h4>
        </div>
    </main>
</body>
