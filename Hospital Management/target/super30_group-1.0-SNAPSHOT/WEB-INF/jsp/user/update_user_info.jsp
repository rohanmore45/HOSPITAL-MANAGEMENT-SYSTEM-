<%-- 
    Document   : update_user_info
    Created on : 25-Feb-2023, 10:50:49 AM
    Author     : Vedan
--%>
...
<%
    String s1 = (String) request.getAttribute("user_2");
%>
            ...
            <nav class="navbar bg-body-emphasis">
                <div class="container-fluid">
                    ...
                    <form action="admindashboard">
                        <button type="submit" class="btn btn-lg btn-outline-light">DASHBOARD</button>
                    </form>
            </nav>
            
        </div>
        
        <form action="update_user22" method="post" class="container form" align="center">
            <div class="row">
            ...
            <div class="row">
                    <div class="col-5"></div>
                    <div class="col-2">
                        <button type="submit" name="id" value="<%=s1%>" class="btn btn-lg btn-light" >Submit</button>
                    </div>
                <div class="col-5"></div>
            </div>
        </form>
