<%-- 
    ...
    Created on : 21-Feb-2023, 9:50:19 AM
    Author     : Vedan
--%>
            ...
            <div class="row">
                ...
                <div class="col-3" ><div class="card" style="background-color: rgba(255, 255, 255, 0.1); width: 18rem;">
                    ...
                    <div class="card-body" align="center">
                      ...
                      <form action="doc_list">
                          <button name="user_89" value="<%=a1%>" class="btn btn-light">View Doctors</button>
                      </form>
                ...
                <div class="col-3"><div class="card" style="background-color: rgba(255, 255, 255, 0.1); width: 18rem;">
                    ...
                    <div class="card-body" align="center">
                      ...
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                      <form action="view_edit_user11" >
                          <button name="user" value="<%=a1%>" class="btn btn-light">View & Edit Details</button>
                      </form>
                    </div>
                  </div></div>
                ...
                <div class="col-3"><div class="card" style="background-color: rgba(255, 255, 255, 0.1); width: 18rem;">
                    ...
                    <div class="card-body" align="center">
                      <!-- <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                      <form action="us_appoi_st" >
                          <button name="user" value="<%=a1%>" class="btn btn-light">check appointment status</button>
                      </form>
                    </div>
                  </div></div>
                <!--<div class="col-2"></div>-->
<!--                <div class="col-3"><div class="card" style="background-color: rgba(255, 255, 255, 0.1); width: 18rem;">
                    ...
                    <div class="card-body" align="center">
                      ...
                      <form action="view_patient" >
                          <button class="btn btn-light">View Doctors</button>
                      </form>
                    </div>-->
                  </div></div>
