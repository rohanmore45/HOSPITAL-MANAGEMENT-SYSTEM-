...
<body>
    <main>
        ...
        <form action="registerred_A" method="post" class="container form" align="center">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-5 form-group">
                        <input type="number" min="1" placeholder="enter age" name="age" class="form-control" required>
                    </div>
